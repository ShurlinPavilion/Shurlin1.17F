...
public class SpiritMeridians {
    ...
    public SpiritMeridians(SpiritPropertyType type, SpiritRootLevel rootLevel, short level, double curSpirit, double curEx) {
        this.type = type;
...
//        tag.putShort("level", thi);
    ...
    public static SpiritMeridians fromTag(SpiritPropertyType type, NbtCompound tag) {
        return new SpiritMeridians(type,SpiritRootLevel.BEST,//TODO
                tag.getShort("level"),
